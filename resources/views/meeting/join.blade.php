@extends('layouts.templatenoside')
...
<div class="container">
    ...
    <script>
        ...
        var authEndpoint = 'http://localhost:8004/api/v1/zoom/signature'; // Laravel endpoint for signature
        const queryParams = new URLSearchParams(window.location.search);
        var sdkKey = 'TmuEla_jRR2Hbq6fz4jA';
        const meetingNumber = queryParams.get('meeting_id');
