    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#table-data').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ env('URL_API') }}/api/v1/assistant/{{ $code }}",
                    "type": "GET",
                ...
                buttons: [{
                    text: '<i class="fa-solid fa-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Add Assistant</span>',
            ...
            }), $("div.head-label").html('<h5 class="card-title mb-0">Assistant Data</h5>');
            ...
            $('#delete-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ env('URL_API') }}/api/v1/assistant/" + guid,
                    data: {
                    ...
                    success: function(result) {
                        window.location.href = "{{ route('assistant', ['code' => $code]) }}";
                    },
            ...
            $('#add-form').on('submit', function(e) {
                e.preventDefault();
                var assistant = $('#user-tag').val();
                const userObject = JSON.parse(assistant);
                var userString = [];
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ env('URL_API') }}/api/v1/assistant",
                    data: {
                        user: userString,
                        course_code: "{{ $code }}"
                    },
            ...
            $.ajax({
                type: "POST",
                url: "{{ env('URL_API') }}/api/v1/user/assistant",
                data: {
                    "code": "{{ $code }}",
                },
                beforeSend: function(request) {
